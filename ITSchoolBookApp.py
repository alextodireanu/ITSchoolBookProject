...
def update_book_reader_writer():
    ...
    try:
        with open("booksDB.csv", mode='r', newline='') as readFile:
            ...
            for row in reader:
                ...
                if row.get(fieldnames[0]) == updated_book.title():
    ...
    try:
        ...
        if True not in book_found:
            ...
            if book_not_found.upper() == "Y":
                readFile.close()
                add_book()
                return
            elif book_not_found.upper() == "N":
                readFile.close()
    ...
    try:
        with open("booksDB.csv", mode='w', newline='') as writeFile:
            ...
            writer.writerow({fieldnames[0]: updated_book.title(),
...
def share_book_reader_writer():
    ...
    try:
        with open("booksDB.csv", mode='r', newline='') as readFile:
            ...
            for row in reader:
                ...
                if row.get(fieldnames[0]) == shared_book.title():
                    book_found.append(True)
                    ...
                    if row.get(fieldnames[2]) != "True":
                        ...
                        if book_not_read.upper() == "Y":
                            is_read = True
                            start_date, end_date = correct_date()
                        elif book_not_read.upper() == "N":
                        ...
                        if row.get(fieldnames[6]) == "None":
                            ...
                            print(f"Book successfully shared with {shared_with.title()}")
                        else:
                            raise TypeError("incorrect button pressed")
                    else:
                        is_read = True
    ...
    try:
        with open("booksDB.csv", mode='w', newline='') as writeFile:
            ...
            writer.writerow({fieldnames[0]: shared_book.title(),
                             fieldnames[1]: row.get(fieldnames[1]),
                             fieldnames[2]: is_read,
                             fieldnames[3]: start_date,
                             fieldnames[4]: end_date,
...
def delete_book():
    ...
    try:
        with open("booksDB.csv", mode='r', newline='') as readFile:
            ...
            for row in reader:
                updated_list.append(row)
                if row[fieldnames[0]] == delete_book.title():
                    book_found.append(True)
                    updated_list.remove(row)
                    print("Book deleted")
                else:
